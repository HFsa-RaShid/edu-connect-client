...
//                 <div className="relative text-center min-h-screen bg-slate-400 w-1/2">
//                     <img src={login} alt="Sign Up" className="w-full h-full object-cover" />
//                     <div className="absolute text-white top-1/3 p-8">
...
//                 <div className="w-1/2 max-w-sm bg-base-100 flex items-center">
...
//                                 type="password" 
//                                 name="password"
//                                 {...register("password", {required: true, pattern: /(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[#?!@$%^&*-])/, minLength: 6, maxLength: 20 })}
...
//                             {errors.password?.type === 'pattern' && <span className="text-red-700 italic">Password must have 1 upper case,1 lowe case, 1 number & 1 special Character </span>}
